module "s3_bucket_source_output_test" {
  ...
  bucket                  = local.splink_source_output_bucket_test_name
  force_destroy           = false
    ...
    Statement = concat([
      {
        ...
        Principal = "*"
        Action    = "s3:*"
        Resource  = ["arn:aws:s3:::${local.splink_source_output_bucket_test_name}", "arn:aws:s3:::${local.splink_source_output_bucket_test_name}/*"]
      ...
      },
      {
        ...
        Principal = "*"
        Action    = "s3:PutObject"
        Resource  = "arn:aws:s3:::${local.splink_source_output_bucket_test_name}/*"
      ...
      },
      {
        ...
        Resource  = "arn:aws:s3:::${local.splink_source_output_bucket_test_name}"
        Condition = { ArnNotEquals = { "aws:PrincipalArn" = [local.splink_s3_source_output_write_test_bucket_key_user_arns] } }
      }
      ], [
      {
      ...
      },
      {
        ...
        Resource  = "arn:aws:s3:::${local.splink_source_output_bucket_test_name}/*"
        Condition = { ArnNotEquals = { "aws:PrincipalArn" = local.splink_s3_source_output_read_test_bucket_key_user_arns } }
      },
      {
        ...
        Resource  = "arn:aws:s3:::${local.splink_source_output_bucket_test_name}"
        Condition = { ArnNotEquals = { "aws:PrincipalArn" = concat(local.splink_s3_source_output_read_test_bucket_key_user_arns, [local.splink_s3_source_output_write_test_bucket_key_user_arns]) } }
      }
    ])
  })
