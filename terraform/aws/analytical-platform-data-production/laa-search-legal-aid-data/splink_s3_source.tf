    ...
    Statement = concat([
      {
        ...
        Principal = "*"
        Action    = "s3:*"
        Resource  = ["arn:aws:s3:::${local.splink_source_bucket_name}", "arn:aws:s3:::${local.splink_source_bucket_name}/*"]
      ...
      },
      {
        ...
        Principal = "*"
        Action    = "s3:PutObject"
        Resource  = "arn:aws:s3:::${local.splink_source_bucket_name}/*"
      ...
      },
      {
        ...
        Resource  = "arn:aws:s3:::${local.splink_source_bucket_name}/*"
        Condition = { ArnNotEquals = { "aws:PrincipalArn" = local.splink_source_s3_read_bucket_key_user_arns } }
      },
      {
      ...
      },
      {
        ...
        Action    = ["s3:PutObject"]
        Resource  = "arn:aws:s3:::${local.splink_source_bucket_name}/*"
        Condition = { ArnNotEquals = { "aws:PrincipalArn" = local.splink_source_s3_write_bucket_key_user_arns } }
      },
      {
