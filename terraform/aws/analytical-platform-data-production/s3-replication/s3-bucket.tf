...
import {
  to = module.alpha-mojap-ho-data-transfer-test.aws_s3_bucket_lifecycle_configuration.this[0]
  id = "alpha-mojap-ho-data-transfer-test"
}

import {
  to = module.alpha-mojap-ho-data-transfer-test.aws_s3_bucket_server_side_encryption_configuration.this[0]
  id = "alpha-mojap-ho-data-transfer-test"
}

import {
  to = module.alpha-mojap-ho-data-transfer-test.aws_s3_bucket_versioning.this[0]
  id = "alpha-mojap-ho-data-transfer-test"
}

import {
  to = module.alpha-mojap-ho-data-transfer-test.aws_s3_bucket_logging.this[0]
  id = "alpha-mojap-ho-data-transfer-test"
}

import {
  to = module.alpha-mojap-ho-data-transfer-test.aws_s3_bucket_public_access_block.this[0]
  id = "alpha-mojap-ho-data-transfer-test"
}
