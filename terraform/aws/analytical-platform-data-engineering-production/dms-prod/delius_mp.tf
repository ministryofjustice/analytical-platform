...
resource "aws_dms_endpoint" "source_delius_mp" {
  ...
  server_name   = "delius-core-prod-db-3.delius-core.hmpps-production.modernisation-platform.service.justice.gov.uk"
