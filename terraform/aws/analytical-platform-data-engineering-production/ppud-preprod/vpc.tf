module "vpc" {
  ...
  private_subnet_names = ["private-eu-west-2a-preprod", "private-eu-west-2b-preprod", "private-eu-west-2c-preprod"]
...
module "endpoints" {
  ...
  security_group_description = "${var.name} ${var.environment} - Managed by Terraform"
