...
resource "aws_iam_role" "flow_log_role" {
  name               = "managed-pipelines-core-preprod-flow-log-role"
  assume_role_policy = data.aws_iam_policy_document.flow_logs_trust.json
  tags               = merge(var.tags, { network = "Private", Name = "managed-pipelines-core-preprod-flow-log-role" })
}
...
resource "aws_iam_role_policy" "cloudwatch_logs" {
  name   = "managed-pipelines-core-preprod-cloudwatch-logs"
  role   = aws_iam_role.flow_log_role.id
  policy = data.aws_iam_policy_document.cloudwatch_logs.json
}

resource "aws_cloudwatch_log_group" "log_group" {
  name              = "managed-pipelines-core-preprod-vpc-flow-log"
...
module "vpc" {
  ...
  private_subnets      = ["172.26.0.0/20", "172.26.16.0/20", "172.26.32.0/20"]
  private_subnet_names = ["private-eu-west-1a-preprod", "private-eu-west-1b-preprod", "private-eu-west-1c-preprod"]
  ...
  vpc_flow_log_tags = {
    Name    = "managed-pipelines-core-preprod"
    network = "Private"
  }
...
module "endpoints" {
  ...
  security_group_tags        = { Name : "eu-west-1-preprod" }
  ...
  endpoints = {
    ...
    s3 = {
      ...
      tags            = { Name = "s3-eu-west-1-preprod" }
    }
    ...
    secrets_manager = {
      ...
      tags                = { Name = "secretsmanager-eu-west-1-preprod" }
    }
    glue = {
      service             = "glue"
      service_type        = "Interface"
      subnet_ids          = module.vpc.private_subnets
      private_dns_enabled = true
      tags                = { Name = "glue-eu-west-1-preprod" }
    }
    sts = {
      service             = "sts"
      service_type        = "Interface"
      subnet_ids          = module.vpc.private_subnets
      private_dns_enabled = true
      tags                = { Name = "sts-eu-west-1-preprod" }
    }
    ...
    #   subnet_ids          = module.vpc.private_subnets
    #   private_dns_enabled = true
    #   tags                = { Name = "ec2messages-eu-west-1c-preprod" }
    # }
    ...
    #   subnet_ids          = module.vpc.private_subnets
    #   private_dns_enabled = true
    #   tags                = { Name = "ssmmessages-eu-west-1c-preprod" }
    # }
