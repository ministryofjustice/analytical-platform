...
provider "registry.terraform.io/auth0/auth0" {
  ...
  constraints = "1.1.0"
  hashes = [
    "h1:7hcckGHCLdSNui9GRGLfVtBVLtUzevo2ZaUx9ysKWB4=",
...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "5.27.0"
  constraints = ">= 3.0.0, >= 3.56.0, >= 4.0.0, >= 4.18.0, >= 4.47.0, >= 5.0.0, >= 5.25.0, 5.27.0"
  hashes = [
