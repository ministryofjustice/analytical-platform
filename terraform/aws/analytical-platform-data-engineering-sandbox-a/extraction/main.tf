...
import {
  to = module.dms.aws_dms_replication_task.full_load_replication_task
  id = "oracle19-1-1-full-load-eu-west-1-sandbox"
}

import {
  to = module.dms.aws_dms_replication_task.cdc_replication_task
  id = "oracle19-1-0-cdc-eu-west-1-sandbox"
}
