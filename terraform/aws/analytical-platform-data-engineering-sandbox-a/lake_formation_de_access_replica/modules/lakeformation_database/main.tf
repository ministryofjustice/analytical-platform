...
data "aws_iam_policy_document" "lakeformation_location_policy" {
  statement {
    ...
    resources = [
      var.location_prefix == null || var.location_prefix == "" ? "arn:aws:s3:::${var.location_bucket}/*" : "arn:aws:s3:::${var.location_bucket}/${var.location_prefix}*",
    ]
  }
...
resource "aws_lakeformation_resource" "lakeformation_location" {
  arn                   = var.location_prefix == null || var.location_prefix == "" ? "arn:aws:s3:::${var.location_bucket}" : "arn:aws:s3:::${var.location_bucket}/${var.location_prefix}"
...
resource "aws_glue_catalog_database" "lakeformation_database" {
  ...
  location_uri = var.location_prefix == null || var.location_prefix == "" ? "s3://${var.location_bucket}" : "s3://${var.location_bucket}/${var.location_prefix}"
}
