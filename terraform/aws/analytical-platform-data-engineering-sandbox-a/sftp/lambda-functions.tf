module "definition_upload_lambda" {
  ...
  memory_size   = 2048
  timeout       = 900
  image_uri     = "684969100054.dkr.ecr.eu-west-2.amazonaws.com/analytical-platform-family-transfer-server:12" # TODO: Remove hardcoding and use data source
...
module "scan_lambda" {
  ...
  memory_size   = 2048
  timeout       = 900
  image_uri     = "684969100054.dkr.ecr.eu-west-2.amazonaws.com/analytical-platform-family-transfer-server:19" # TODO: Remove hardcoding and use data source
