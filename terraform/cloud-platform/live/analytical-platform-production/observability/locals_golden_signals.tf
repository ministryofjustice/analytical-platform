locals {
  ...
  golden_signals = {
    ...
    eks_node_disk           = { group = "EKS", namespace = "ContainerInsights", metric = "node_filesystem_utilization", statistic = "Average", type = "lt", dim_key = "ClusterName", match_exact = true, warning = "eks_node_disk_warn", critical = "eks_node_disk_crit" }
    ...
    # ── Redis ─────────────────────────────────────────────────────────────────
    redis_curr_connections     = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "CurrConnections", statistic = "Maximum", type = "gt", dim_key = "CacheClusterId", warning = "redis_curr_conn_warn", critical = "redis_curr_conn_crit" }
    redis_net_in               = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "NetworkBytesIn", statistic = "Sum", type = "baseline_gt", dim_key = "CacheClusterId", warning = "redis_net_baseline_warn", critical = "redis_net_baseline_crit" }
    redis_net_out              = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "NetworkBytesOut", statistic = "Sum", type = "baseline_gt", dim_key = "CacheClusterId", warning = "redis_net_baseline_warn", critical = "redis_net_baseline_crit" }
    redis_evictions            = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "Evictions", statistic = "Sum", type = "gt", dim_key = "CacheClusterId", warning = "redis_evictions_warn", critical = "redis_evictions_crit" }
    redis_replication_lag      = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "ReplicationLag", statistic = "Maximum", type = "gt", dim_key = "CacheClusterId", warning = "redis_replication_lag_warn", critical = "redis_replication_lag_crit" }
    redis_cpu                  = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "EngineCPUUtilization", statistic = "Average", type = "gt", dim_key = "CacheClusterId", warning = "redis_cpu_warn", critical = "redis_cpu_crit" }
    redis_swap                 = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "SwapUsage", statistic = "Maximum", type = "gt", dim_key = "CacheClusterId", warning = "redis_swap_warn", critical = "redis_swap_crit" }
    redis_replication_bytes    = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "ReplicationBytes", statistic = "Sum", type = "baseline_gt", dim_key = "CacheClusterId", warning = "redis_replication_bytes_warn", critical = "redis_replication_bytes_crit" }
    redis_host_cpu             = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "CPUUtilization", statistic = "Average", type = "gt", dim_key = "CacheClusterId", warning = "redis_host_cpu_warn", critical = "redis_host_cpu_crit" }
    redis_db_memory_pct        = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "DatabaseMemoryUsagePercentage", statistic = "Maximum", type = "gt", dim_key = "CacheClusterId", warning = "redis_db_memory_pct_warn", critical = "redis_db_memory_pct_crit" }
    redis_bytes_used_for_cache = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "BytesUsedForCache", statistic = "Maximum", type = "baseline_gt", dim_key = "CacheClusterId", warning = "redis_bytes_used_baseline_warn", critical = "redis_bytes_used_baseline_crit" }
    redis_freeable_memory      = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "FreeableMemory", statistic = "Minimum", type = "lt", dim_key = "CacheClusterId", warning = "redis_freeable_mem_warn", critical = "redis_freeable_mem_crit" }
    redis_new_connections      = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "NewConnections", statistic = "Sum", type = "baseline_gt", dim_key = "CacheClusterId", warning = "redis_new_conn_baseline_warn", critical = "redis_new_conn_baseline_crit" }
    redis_reclaimed            = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "Reclaimed", statistic = "Sum", type = "gt", dim_key = "CacheClusterId", warning = "redis_reclaimed_warn", critical = "redis_reclaimed_crit" }
    redis_save_in_progress     = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "SaveInProgress", statistic = "Maximum", type = "gt", dim_key = "CacheClusterId", warning = "redis_save_in_progress_warn", critical = "redis_save_in_progress_crit" }
    redis_net_packets_in       = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "NetworkPacketsIn", statistic = "Sum", type = "baseline_gt", dim_key = "CacheClusterId", warning = "redis_net_packets_baseline_warn", critical = "redis_net_packets_baseline_crit" }
    redis_net_packets_out      = { group = "Control Panel", namespace = "AWS/ElastiCache", metric = "NetworkPacketsOut", statistic = "Sum", type = "baseline_gt", dim_key = "CacheClusterId", warning = "redis_net_packets_baseline_warn", critical = "redis_net_packets_baseline_crit" }
