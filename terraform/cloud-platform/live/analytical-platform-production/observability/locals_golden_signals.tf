locals {
  ...
  golden_signals = {
    ...
    mwaa_dag_duration_success = { group = "MWAA", namespace = "AmazonMWAA", metric = "DAGDurationSuccess", statistic = "Average", type = "gt", dim_key = "", warning = "mwaa_dag_duration_baseline_warn", critical = "mwaa_dag_duration_baseline_crit" }
