locals {
  ...
  golden_signals = {
    ...
    eks_node_network_rx    = { group = "EKS", namespace = "ContainerInsights", metric = "node_network_rx_bytes", statistic = "Sum", type = "baseline_gt", dim_key = "", warning = "eks_node_net_baseline_warn", critical = "eks_node_net_baseline_crit" }
    ...
    eks_node_memory        = { group = "EKS", namespace = "ContainerInsights", metric = "node_memory_utilization", statistic = "Average", type = "gt", dim_key = "", warning = "eks_node_mem_warn", critical = "eks_node_mem_crit" }
    eks_node_disk          = { group = "EKS", namespace = "ContainerInsights", metric = "node_filesystem_utilization", statistic = "Average", type = "gt", dim_key = "", warning = "eks_node_disk_warn", critical = "eks_node_disk_crit" }
    eks_pod_cpu_throttle   = { group = "EKS", namespace = "ContainerInsights", metric = "pod_cpu_utilization_over_pod_limit", statistic = "Average", type = "gt", dim_key = "", warning = "eks_pod_cpu_throttle_warn", critical = "eks_pod_cpu_throttle_crit" }
    eks_pod_memory_limit   = { group = "EKS", namespace = "ContainerInsights", metric = "pod_memory_utilization_over_pod_limit", statistic = "Average", type = "gt", dim_key = "", warning = "eks_pod_mem_limit_warn", critical = "eks_pod_mem_limit_crit" }
    ...
    # ── Control Panel ─────────────────────────────────────────────────────────
    cp_pod_cpu_throttle  = { group = "Control Panel", namespace = "ContainerInsights", metric = "pod_cpu_utilization_over_pod_limit", statistic = "Average", type = "gt", dim_key = "Namespace", warning = "cp_pod_cpu_throttle_warn", critical = "cp_pod_cpu_throttle_crit" }
    cp_pod_net_rx        = { group = "Control Panel", namespace = "ContainerInsights", metric = "pod_network_rx_bytes", statistic = "Sum", type = "baseline_gt", dim_key = "Namespace", warning = "cp_pod_net_baseline_warn", critical = "cp_pod_net_baseline_crit" }
    cp_pod_net_tx        = { group = "Control Panel", namespace = "ContainerInsights", metric = "pod_network_tx_bytes", statistic = "Sum", type = "baseline_gt", dim_key = "Namespace", warning = "cp_pod_net_baseline_warn", critical = "cp_pod_net_baseline_crit" }
