...
data "aws_secretsmanager_secret" "cloud_platform_live_data_platform_development_token" {
  provider = aws.analytical-platform-management-production

  name = "cloud-platform/live/data-platform-development/token"
}

data "aws_secretsmanager_secret_version" "cloud_platform_live_data_platform_development_token" {
  provider = aws.analytical-platform-management-production

  secret_id = data.aws_secretsmanager_secret.cloud_platform_live_data_platform_development_token.id
}
