...
declare -xr PATH_FILTER_CONFIGURATION_FILE=".github/workflows/path-filter/terraform.yml"
...
# https://github.com/ministryofjustice/data-platform/blob/main/scripts/path-filter/terraform-generator.sh
