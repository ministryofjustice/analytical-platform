The soft serve container will use [Soft Serve](https://github.com/charmbracelet/soft-serve) by [charm](https://github.com/charmbracelet/) to provide an easy to navigate TUI available over SSH. 
