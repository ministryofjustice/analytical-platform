...
The [published](https://technical-documentation.data-platform.service.justice.gov.uk/) documentation is created by editing `*.html.md.erb` files, found in the [docs source](docs/source/) folder.
